...
//wtf setup da camera o proprio arduino ajudou
typedef struct {
        httpd_req_t *req;
        size_t len;
} jpg_chunking_t;
...
//pega img da camera e retorna como JPEG 
...
//mostra uma serie de JPEG e envia atraves do http 
    ...
    <figure>
      <div id="stream-container" class="image-container hidden">
        ...
        <section class="main">
            <section id="buttons">
                <table>
                <tr><td align="center"><button id="get-still">Imagem Estática</button></td><td><td>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</td><td align="center"><button id="toggle-stream">Comece a Stream</button></td></tr>
                ...
                <tr><td></td><td align="center" colspan="2"></br></tr>
                <tr><td></td><td align="center" colspan="2"></br></tr>
                <tr><td>Servo Base</td><td align="center" colspan="2"><input type="range" id="servoB" min="0" max="650" value="487" onchange="try{fetch(document.location.origin+'/control?var=servoB&val='+this.value);}catch(e){}"><td></td></tr>
                <tr><td>Servo Camera</td><td align="center" colspan="2"><input type="range" id="servoC" min="325" max="650" value="487" onchange="try{fetch(document.location.origin+'/control?var=servoC&val='+this.value);}catch(e){}"><td></td></tr>
                ...
                <tr><td>Resolução</td><td align="center" colspan="2"><input type="range" id="framesize" min="0" max="6" value="5" onchange="try{fetch(document.location.origin+'/control?var=framesize&val='+this.value);}catch(e){}"><td></td></tr>
                <tr><td>Qualidade</td><td align="center" colspan="2"><input type="range" id="quality" min="10" max="63" value="10" onchange="try{fetch(document.location.origin+'/control?var=quality&val='+this.value);}catch(e){}"><td></td></tr>
...
void startCameraServer()
{
   ...
   httpd_uri_t stream_uri = {
    ...
    Serial.printf("Começando server na porta: '%d'\n", config.server_port);
    ...
    config.ctrl_port += 1;
    Serial.printf("Começando stream na porta: '%d'\n", config.server_port);
